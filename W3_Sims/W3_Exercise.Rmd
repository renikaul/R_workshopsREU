...
The `ggplot()` function requires data in a data.frame. What is the current object class? Based on the reading for today, how can we convert `sim1` and `sim2` to a data.frame?
