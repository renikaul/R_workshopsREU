...
![](W1_Intro-figure/read-a-help-page.png)
...
2. Decide how the dataset needs to be manipulated. 
3. Write the code for the analysis
...
4. When you are finished save the file with your group number (ie. `W1_Group1.Rmd`) and email it to your group members and INSTRUCTOR NAME (EMAIL). 
