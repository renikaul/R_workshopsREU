...
# Group 1: Challenge 2 Scatter plot
...
# Group 2: Challenge 2 Multi-panel plots
...
#Group 3: Challenge 2 Violin plots
...
# Group 4: Challenge 2 Weighted scatter plot
...
ggplot(aq_trim, aes(x = Day, y = Ozone, size = Wind, fill=Month)) + #define dataset, x,y, color and point size
        geom_point(shape = 21)+ #set points to be triangles 
